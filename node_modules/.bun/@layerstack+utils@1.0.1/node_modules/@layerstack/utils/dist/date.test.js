...
import { formatDate, getMonthDaysByWeek, localToUtcDate, utcToLocalDate, formatIntl, formatDateWithLocale, getPeriodTypeByCode, getPeriodTypeCode, getDayOfWeek, hasDayOfWeek, replaceDayOfWeek, isStringDate, } from './date.js';
...
describe('formatDate()', () => {
    ...
    describe('should format date for PeriodType.Day', () => {
        ...
        for (const c of cases) {
            ...
            it(c.toString(), () => {
                expect(formatDateWithLocale(locales, localDate, PeriodType.Day, { variant })).equal(expected);
            });
        }
    });
    describe('should format date string for PeriodType.Day', () => {
        ...
        for (const c of cases) {
            const [variant, locales, expected] = c;
            it(c.toString(), () => {
                expect(formatDateWithLocale(locales, testDate, PeriodType.Day, { variant })).equal(expected);
            });
        }
    });
    ...
    describe('should format date for PeriodType.Month', () => {
        ...
        for (const c of cases) {
            const [variant, locales, expected] = c;
            it(c.toString(), () => {
                expect(formatDateWithLocale(locales, testDate, PeriodType.Month, { variant })).equal(expected);
            });
        }
    });
    describe('should format date for PeriodType.MonthYear', () => {
        ...
        for (const c of cases) {
            const [variant, locales, expected] = c;
            it(c.toString(), () => {
                expect(formatDateWithLocale(locales, testDate, PeriodType.MonthYear, { variant })).equal(expected);
            });
        }
    });
    describe('should format date for PeriodType.Quarter', () => {
        ...
        for (const c of cases) {
            const [variant, locales, expected] = c;
            it(c.toString(), () => {
                expect(formatDateWithLocale(locales, testDate, PeriodType.Quarter, { variant })).equal(expected);
            });
        }
    });
    describe('should format date for PeriodType.CalendarYear', () => {
        ...
        for (const c of cases) {
            const [variant, locales, expected] = c;
            it(c.toString(), () => {
                expect(formatDateWithLocale(locales, testDate, PeriodType.CalendarYear, { variant })).equal(expected);
            });
        }
    });
    describe('should format date for PeriodType.FiscalYearOctober', () => {
        ...
        for (const c of cases) {
            const [variant, locales, expected] = c;
            it(c.toString(), () => {
                expect(formatDateWithLocale(locales, testDate, PeriodType.FiscalYearOctober, { variant })).equal(expected);
            });
        }
    });
    describe('should format date for PeriodType.BiWeek1Sun', () => {
        ...
        for (const c of cases) {
            const [variant, locales, expected] = c;
            it(c.toString(), () => {
                expect(formatDateWithLocale(locales, testDate, PeriodType.BiWeek1Sun, { variant })).equal(expected);
            });
        }
    });
