 ...
 */
export function createThemeColors(colorSpace) {
 ...
 */
export function getThemeNames(themes) {
    const light = [];
    const dark = [];
 ...
 */
export function flattenThemeColors(themeColors, keys = [], memo) {
 ...
 */
export function processThemeColors(themeColors, colorSpace) {
 ...
 */
export function colorVariableValue(color, colorSpace, decimals = 4) {
    try {
        if (colorSpace === 'rgb') {
 ...
 */
export function themeStylesString(theme, colorSpace) {
